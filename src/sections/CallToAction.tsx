        ...
        <SectionBorder borderTop>
          <SectionContent className="relative isolate">
            ...
            <h2 className="text-gray-200 font-semibold text-3xl md:text-4xl lg:text-5xl max-w-3xl mx-auto text-center leading-tight">
              Creating and Transforming companies with
            ...
            <p className="text-center text-xl mt-8 max-w-2xl mx-auto">
              We understand thr Passion , hardwork and dedication of a growing company/Product. Join hands with us.
            </p>
            <div className="flex justify-center mt-10">
              <a href="https://www.joshtechnologygroup.com/">
              <Button variant="secondary">Get Started</Button></a>
            </div>
          </SectionContent>
        </SectionBorder>
      </div>
